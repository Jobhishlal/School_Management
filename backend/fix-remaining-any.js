...
for (const f of allFiles) {
  ...
  // Replace : any[]
  content = content.replace(/:\s*any\[\]/g, ': ReturnType<typeof JSON.parse>[]');
  // Replace Record<string, any>
  content = content.replace(/Record<string,\s*any>/g, 'Record<string, ReturnType<typeof JSON.parse>>');
  // Replace :any
  content = content.replace(/:any\b/g, ': ReturnType<typeof JSON.parse>');
