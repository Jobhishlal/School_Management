...
export function validateStudentCreate(data: ReturnType<typeof JSON.parse>): void {
...
export function validateStudentUpdate(data: ReturnType<typeof JSON.parse>): void {
