...
export function validateAssignmentCreate(data: ReturnType<typeof JSON.parse>): void {
...
export function validateAssignmentUpdate(data: ReturnType<typeof JSON.parse>): void {
    AssignmentEntity.validate(data);
}
