...
const SchoolLandingPage = () => {
  ...
  return (
    <div className={`min-h-screen overflow-x-hidden transition-all duration-700 font-inter ${isDark ? 'bg-[#1E1E1E] text-white' : 'bg-white text-slate-900'}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 lg:h-20">
            <div className="flex items-center space-x-3">
              <div className={`w-10 h-10 lg:w-12 lg:h-12 rounded-xl ${isDark ? 'bg-blue-600' : 'bg-blue-500'} flex items-center justify-center shadow-lg`}>
      ...
      className={`px-6 py-3 text-base rounded-lg transition-all duration-300 hover:scale-105 ${
        isDark
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
          <div className="text-center space-y-8 lg:space-y-12">
            <div className={`inline-flex items-center space-x-2 px-4 py-2 lg:px-6 lg:py-3 rounded-full ${isDark ? 'bg-gray-800/70 border-white/10' : 'bg-slate-100/80 border-slate-200'} backdrop-blur-sm border text-sm lg:text-base`}>
              ...
              <span className="font-medium">BRAINNIX</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 lg:mb-20">
            ...
            <p className={`text-lg lg:text-xl ${isDark ? 'text-gray-300' : 'text-slate-600'} mb-8 lg:mb-12 max-w-2xl mx-auto`}>
              Join thousands of forward-thinking companies that have already revolutionized their operations with BRAINNIX.
            </p>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="relative z-10">
                  <div className={`inline-flex items-center justify-center w-14 h-14 lg:w-20 lg:h-20 rounded-xl lg:rounded-2xl mb-6 lg:mb-8 transition-all duration-500 group-hover:scale-110 ${
                    feature.accent === 'blue' ? (isDark ? 'bg-blue-600 text-white' : 'bg-blue-500 text-white') :
      ...
      <section className="py-16 lg:py-32 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className={`text-lg lg:text-xl ${isDark ? 'text-gray-300' : 'text-slate-600'} mb-8 lg:mb-12 max-w-3xl mx-auto`}>
            Join thousands of enterprises leveraging BRAINNIX to achieve operational excellence and drive sustainable growth.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className={`text-center border-t ${isDark ? 'border-white/10' : 'border-slate-200'} pt-6 lg:pt-8 mt-6 lg:mt-8`}>
            <p className={`text-sm lg:text-base ${isDark ? 'text-gray-400' : 'text-slate-500'}`}>
              © 2025 BRAINNIX. All rights reserved. Built for enterprise excellence.
            </p>
